...
nhadat247_thue = pd.read_csv('./crawled_data/nhadat247_thue.csv',encoding='utf-8')

cleaned_nhadat247_thue = clean_dataframe(nhadat247_thue)
...
cleaned_nhadat247_thue['Created_date'] = cleaned_nhadat247_thue.apply(replace_dates, axis=1)
...
cleaned_nhadat247_thue['Price'] = cleaned_nhadat247_thue.apply(convert_to_vnd,axis=1)
cleaned_nhadat247_thue['Location'] = cleaned_nhadat247_thue['Location'].apply(clean_location)
cleaned_nhadat247_thue['Standardized_Location'] = cleaned_nhadat247_thue['Location'].apply(lambda address: standardize_address(address))
cleaned_nhadat247_thue['Standardized_Location'] = cleaned_nhadat247_thue.apply(fill_empty_location, axis=1)
cleaned_nhadat247_thue.to_csv('./processed_data/nhadat247/processed_nhadat247_thue.csv', index=False)
cleaned_nhadat247_thue['Best_Match_Location'] = cleaned_nhadat247_thue.apply(find_best_match, axis=1)

cleaned_nhadat247_thue[['Ward', 'District', 'City']] = cleaned_nhadat247_thue['Best_Match_Location'].apply(lambda x: pd.Series(split_location(x)))
