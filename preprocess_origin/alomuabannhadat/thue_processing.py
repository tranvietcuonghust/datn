...
alomuabannhadat_thue = pd.read_csv('./crawled_data/alomuabannhadat_thue.csv',encoding='utf-8')

cleaned_alomuabannhadat_thue = clean_dataframe(alomuabannhadat_thue)
...
cleaned_alomuabannhadat_thue['Created_date'] = cleaned_alomuabannhadat_thue['Created_date'].dt.strftime('%Y-%m-%d')
...
cleaned_alomuabannhadat_thue['Price'] = cleaned_alomuabannhadat_thue.apply(convert_to_vnd,axis=1)
cleaned_alomuabannhadat_thue['Location'] = cleaned_alomuabannhadat_thue['Location'].apply(clean_location)
...
cleaned_alomuabannhadat_thue['Standardized_Location'] = cleaned_alomuabannhadat_thue['Location'].apply(lambda address: standardize_address(address))
cleaned_alomuabannhadat_thue['Standardized_Location'] = cleaned_alomuabannhadat_thue.apply(fill_empty_location, axis=1)
cleaned_alomuabannhadat_thue.to_csv('./processed_data/alomuabannhadat/processed_alomuabannhadat_thue.csv', index=False)
cleaned_alomuabannhadat_thue['Best_Match_Location'] = cleaned_alomuabannhadat_thue.apply(find_best_match, axis=1)

cleaned_alomuabannhadat_thue[['Ward', 'District', 'City']] = cleaned_alomuabannhadat_thue['Best_Match_Location'].apply(lambda x: pd.Series(split_location(x)))
