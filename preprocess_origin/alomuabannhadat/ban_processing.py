...
alomuabannhadat_ban = pd.read_csv('./crawled_data/alomuabannhadat_ban.csv',encoding='utf-8')

cleaned_alomuabannhadat_ban = clean_dataframe(alomuabannhadat_ban)
...
cleaned_alomuabannhadat_ban['Created_date'] = cleaned_alomuabannhadat_ban['Created_date'].dt.strftime('%Y-%m-%d')
...
cleaned_alomuabannhadat_ban['Price'] = cleaned_alomuabannhadat_ban.apply(convert_to_vnd,axis=1)
cleaned_alomuabannhadat_ban['Location'] = cleaned_alomuabannhadat_ban['Location'].apply(clean_location)
# cleaned_alomuabannhadat_ban['Location'].to_csv('./processed_data/alomuabannhadat/processed_alomuabannhadat_ban.csv', index=False)
cleaned_alomuabannhadat_ban['Standardized_Location'] = cleaned_alomuabannhadat_ban['Location'].apply(lambda address: standardize_address(address))
cleaned_alomuabannhadat_ban['Standardized_Location'] = cleaned_alomuabannhadat_ban.apply(fill_empty_location, axis=1)
cleaned_alomuabannhadat_ban.to_csv('./processed_data/alomuabannhadat/processed_alomuabannhadat_ban.csv', index=False)
cleaned_alomuabannhadat_ban['Best_Match_Location'] = cleaned_alomuabannhadat_ban.apply(find_best_match, axis=1)

cleaned_alomuabannhadat_ban[['Ward', 'District', 'City']] = cleaned_alomuabannhadat_ban['Best_Match_Location'].apply(lambda x: pd.Series(split_location(x)))
