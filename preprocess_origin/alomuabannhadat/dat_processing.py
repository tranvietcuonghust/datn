...
alomuabannhadat_dat = pd.read_csv('./crawled_data/alomuabannhadat_dat.csv',encoding='utf-8')

cleaned_alomuabannhadat_dat = clean_dataframe(alomuabannhadat_dat)
...
cleaned_alomuabannhadat_dat['Created_date'] = cleaned_alomuabannhadat_dat['Created_date'].dt.strftime('%Y-%m-%d')
...
cleaned_alomuabannhadat_dat['Price'] = cleaned_alomuabannhadat_dat.apply(convert_to_vnd,axis=1)
cleaned_alomuabannhadat_dat['Location'] = cleaned_alomuabannhadat_dat['Location'].apply(clean_location)
# cleaned_alomuabannhadat_dat['Location'].to_csv('./processed_data/alomuabannhadat/processed_alomuabannhadat_dat.csv', index=False)
cleaned_alomuabannhadat_dat['Standardized_Location'] = cleaned_alomuabannhadat_dat['Location'].apply(lambda address: standardize_address(address))
cleaned_alomuabannhadat_dat['Standardized_Location'] = cleaned_alomuabannhadat_dat.apply(fill_empty_location, axis=1)
cleaned_alomuabannhadat_dat.to_csv('./processed_data/alomuabannhadat/processed_alomuabannhadat_dat.csv', index=False)
cleaned_alomuabannhadat_dat['Best_Match_Location'] = cleaned_alomuabannhadat_dat.apply(find_best_match, axis=1)

cleaned_alomuabannhadat_dat[['Ward', 'District', 'City']] = cleaned_alomuabannhadat_dat['Best_Match_Location'].apply(lambda x: pd.Series(split_location(x)))
