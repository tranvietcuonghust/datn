...
cafeland_ban = pd.read_csv('./crawled_data/cafeland_ban.csv',encoding='utf-8')

cleaned_cafeland_ban = clean_dataframe(cafeland_ban)
...
cleaned_cafeland_ban['Price'] = cleaned_cafeland_ban.apply(convert_to_vnd,axis=1)
cleaned_cafeland_ban['Location'] = cleaned_cafeland_ban['Location'].apply(clean_location)
# cleaned_cafeland_ban['Location'].to_csv('./processed_data/cafeland/processed_cafeland_ban.csv', index=False)
cleaned_cafeland_ban['Standardized_Location'] = cleaned_cafeland_ban['Location'].apply(lambda address: standardize_address(address))
cleaned_cafeland_ban['Standardized_Location'] = cleaned_cafeland_ban.apply(fill_empty_location, axis=1)
cleaned_cafeland_ban.to_csv('./processed_data/cafeland/processed_cafeland_ban.csv', index=False)
cleaned_cafeland_ban['Best_Match_Location'] = cleaned_cafeland_ban.apply(find_best_match, axis=1)

cleaned_cafeland_ban[['Ward', 'District', 'City']] = cleaned_cafeland_ban['Best_Match_Location'].apply(lambda x: pd.Series(split_location(x)))
