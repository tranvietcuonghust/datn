...
def standardize_address(address):
  ...
  return result
nhadatvui_ban = pd.read_csv('./crawled_data/nhadatvui_ban.csv')
...
cleaned_nhadatvui_ban['Standardized_Location'] = cleaned_nhadatvui_ban['Location'].apply(lambda address: standardize_address(address))
